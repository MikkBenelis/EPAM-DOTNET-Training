namespace Logic.BookingSystem
{
    ...
    public class Book : IEquatable<Book>, IComparable<Book>, IFormattable
    {
        ...
        /// <summary>Full book sting info</summary>
        /// <returns>book full string representation</returns>
        ...
        /// <summary>Short book string info</summary>
        /// <returns>book short string representation</returns>
        ...
        /// <summary>To formated string</summary>
